    ...
    return (
        <div className='footer-container'>
            ...
            <div className='footer-row'>
                ...
                <h2>Penn State, State College 16801</h2>
                <h2>juan@gotimeagency.org</h2>
            ...
            <h3 style={{ textAlign: 'center' }}>© 2024 GoTime LLC</h3>
            <h3 style={{ textAlign: 'center' }}>Website Designed by <a target="_blank" rel='noreferrer' href='https://justincote.netlify.app/'>Justin Cote</a> </h3>
        </div>
    )
}
